...
| `/stats` | ادمین | مشاهده آمار کل کاربران، تعداد دانلودها و کاربران فعال ۲۴ ساعت |
| `/allow <user_id>` | ادمین | اعطای دسترسی به یک کاربر مشخص در حالت خصوصی |
| `/disallow <user_id>` | ادمین | لغو دسترسی کاربر در حالت خصوصی |
| `/set_cookie <auth_token>` | ادمین | تنظیم کوکی احراز هویت توییتر جهت دانلود اکانت‌های حساس (NSFW) |
